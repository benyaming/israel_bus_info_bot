...
stop_button = 'Stop updating'
stop_alert = 'Will stop soon.'
incorrect_message = 'Text is incorrect, send station number!'
invalid_station = 'This station number is not exists in the system!'
api_not_responding = 'The source of core data is unavailable for the moment. Please, try again later.'
